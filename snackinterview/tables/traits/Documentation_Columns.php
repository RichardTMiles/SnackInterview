...
namespace SnackInterview\Tables\Traits;

trait Documentation_Columns
{
     ...
     *
     *    public Documentation $carbon_documentation;
     *
     * The definition above can be defined with the following ::
     *
     *    $carbon_documentation = new Documentation($return);
     *
