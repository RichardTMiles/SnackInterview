...
namespace SnackInterview\Tables;

// Restful defaults
use CarbonPHP\Interfaces\iRestNoPrimaryKey;
use SnackInterview\Tables\Traits\Feature_Group_References_Columns;
...
class Feature_Group_References extends Rest implements iRestNoPrimaryKey
{
    ...
    public const CLASS_NAMESPACE = 'SnackInterview\Tables\\';
    ...
    public const QUERY_WITH_DATABASE = false;
    
    public const DATABASE = '';
    
    public const JSON_COLUMNS = [];

    public const AUTO_ESCAPE_POST_HTML_SPECIAL_CHARS = false;
