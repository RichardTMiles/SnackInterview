...
--
-- Host: 127.0.0.1    Database: SnackInterview
-- ------------------------------------------------------
...
--
-- Table structure for table `carbon_carbons`
--

DROP TABLE IF EXISTS `carbon_carbons`;
...
--
-- Table structure for table `carbon_documentation`
--

DROP TABLE IF EXISTS `carbon_documentation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `carbon_feature_group_references`
--

DROP TABLE IF EXISTS `carbon_feature_group_references`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `carbon_features`
--

DROP TABLE IF EXISTS `carbon_features`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `carbon_group_references`
--
...
--
-- Table structure for table `carbon_groups`
--
...
--
-- Table structure for table `carbon_history_logs`
--

DROP TABLE IF EXISTS `carbon_history_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `carbon_location_references`
--
...
--
-- Table structure for table `carbon_user_groups`
--

DROP TABLE IF EXISTS `carbon_user_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
-- Dump completed on 2023-09-15 14:47:41
